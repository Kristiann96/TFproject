...
Simplified to use only one year of input data
"""
import os
import pandas as pd
import numpy as np
...
class PopulationPredictor:
    ...
    def prepare_data_for_prediction(self, current_data):
        """Prepare the data for prediction - simplified for single year input"""
    ...
    def make_predictions(self, X, grunnkrets_mapping, features_df, year):
        """Make predictions for a future year using simplified model"""
        ...
        # Make predictions with single year input
    ...
    def generate_predictions(self, start_year=None, end_year=None):
        """Generate predictions for a range of years using simplified model"""
        ...
        for year in range(start_year, end_year + 1):
            ...
            # Prepare data for prediction (simplified - only using current data)
            X, grunnkrets_mapping, features_df = self.prepare_data_for_prediction(current_year_data)
            ...
            # Update current year data with predictions for next year's input
